...
**Success — `200 OK`:** the updated ticket row. If `sprintId` was changed, subsequent `GET`s must use the _new_ `:sprintId` in the URL — the old sprint's list/get routes will 404 for this ticket.
